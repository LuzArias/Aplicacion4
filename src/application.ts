...
import {EstrategiaAdmin} from './Estrategia/admin.strategy';
import {EstrategiaCliente} from './Estrategia/cliente.strategy';
import {EstrategiaVendedor} from './Estrategia/vendedor.strategy';
